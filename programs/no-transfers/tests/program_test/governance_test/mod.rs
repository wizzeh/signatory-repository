...
impl GovernanceTest {
    ...
    pub fn get_default_set_realm_config_args(&mut self) -> SetRealmConfigArgs {
        let realm_config_args = RealmConfigArgs {
            ...
            use_community_voter_weight_addin: self.community_voter_weight_addin.is_some(),
            use_max_community_voter_weight_addin: self.max_community_voter_weight_addin.is_some(),
        };
    ...
    pub async fn with_governance_impl(
        ...
        let account = GovernanceV2 {
            ...
            signatories_count: 0,
            reserved_v2: [0; 64],
            reserved_v2_2: Default::default(),
            reserved_v2_3: Default::default(),
        };
